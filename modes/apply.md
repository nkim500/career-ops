...
8. PRESENT   → Show formatted responses ready for copy-paste
```
...
- Or state the company + role so we can look it up
...
- **New question** → generate a response from the report + cv.md
